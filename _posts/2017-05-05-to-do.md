...
### Chapter Two: In which Matrices are Built 
...
### Chapter Three: In which Books are Turned into Numbers and What Happens Then
Fortunately, there is an easy way to calculate the tf-idf matrix for a collections of documents. Behold, the power of scikit-learn: 
